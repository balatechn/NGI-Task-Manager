...
// Reuse AuthRequest type inline since this is standalone
...
export async function createTask(req: AuthRequest, res: Response): Promise<void> {
  ...
  if (!taskName || !startDate || !endDate) { res.status(400).json({ error: 'taskName, startDate, endDate are required' }); return; }
